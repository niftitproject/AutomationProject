			...
			<!-- MAIN -->
				...
				<div class="wrapper">
                    ...
                    <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="672px" 
                       ...
                       <div class="three-fourth ">
							<h6 class="line-divider">List Of Proposal</h6>
                            <b><asp:Label ID="Label4" runat="server" Text="List Of Proposal"></asp:Label></b>
                            <br />
                            <asp:GridView ID="GridView2" runat="server" AllowPaging="True" 
                                AutoGenerateColumns="False" CellPadding="4" DataKeyNames="ID_Proposal" 
                                DataSourceID="SqlDataSource4" ForeColor="#333333" GridLines="None" PageSize="4" 
                                Width="667px">
                                <AlternatingRowStyle BackColor="White" />
                                <Columns>
                                    <asp:BoundField DataField="Company_Name" HeaderText="Company_Name" 
                            ...
                            <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
                                ...
                                SelectCommand="SELECT Company_Name, Context, Status, ID_Proposal FROM Proposal WHERE Proposal.UserId = @id">
                                <SelectParameters>
                                    <asp:SessionParameter Name="id" SessionField="ProviderUserKey" />
                                </SelectParameters>
                            </asp:SqlDataSource>
