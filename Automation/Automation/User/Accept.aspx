<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Accept.aspx.cs" Inherits="Automation.User.Accept" %>
    ...
    <form id="form1" runat="server">
			...
			<!-- MAIN -->
				...
				<div class="wrapper">
					...
					<!-- title -->
					<div id="page-title">
						<span class="title">Accepted Proposal</span>
					...
					<!-- page-content -->
					<div id="page-content">						
			            Do you want accept this proposal
                        <asp:Button ID="btnAccept" runat="server" Text="Accepted" 
