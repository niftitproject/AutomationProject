...
namespace Automation
{
    public partial class WebForm5 : System.Web.UI.Page
    {
        ...
        protected void Search_Click(object sender, EventArgs e)
        {
            ...
            {
                string selectCommand = "SELECT RFP_Question.Name_Of_Customer, RFP_Question.Name_Of_Company, RFP_Question.RFP_Title, RFP_Question.Deadline, RFP_Question.Budget, RFP_Options.Description, RFP_File.Name, RFP_Question.ID_RFP_Question FROM RFP_Question INNER JOIN RFP_File ON RFP_Question.ID_File = RFP_File.ID_File AND RFP_Question.ID_RFP_Question = RFP_File.ID_File INNER JOIN RFP ON RFP_Question.ID_RFP = RFP.ID_RFP INNER JOIN RFP_Options ON RFP.ID_Options = RFP_Options.ID_Options where (Name_Of_Customer LIKE '" + SearchTxt.Text + "' or Name_Of_Company LIKE '" + SearchTxt.Text + "' or RFP_Title LIKE '" + SearchTxt.Text + "')";
