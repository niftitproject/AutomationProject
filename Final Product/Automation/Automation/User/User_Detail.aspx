                    ...
                    <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="672px" 
                        ...
                        <RowStyle BackColor="#EFF3FB" />
                            ...
                            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                                ...
                                <AlternatingRowStyle BackColor="White" />
                                <Columns>
                                    <asp:BoundField DataField="RFP_Title" HeaderText="RFP_Title" 
                                        SortExpression="RFP_Title" />
                                    <asp:BoundField DataField="Deadline" HeaderText="Deadline" 
                                        SortExpression="Deadline" />
                                    <asp:BoundField DataField="ID_RFP" HeaderText="ID_RFP" InsertVisible="False" 
                                        ReadOnly="True" SortExpression="ID_RFP" />
