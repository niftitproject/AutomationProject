...
&nbsp;&nbsp;&nbsp; to&nbsp;&nbsp;&nbsp;
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Notes" HeaderText="Option" SortExpression="Notes" />
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:ApplicationServices %>" 
                                ...
                                SelectCommand="SELECT RFP_Question.Name_Of_Customer, RFP_Question.Name_Of_Company, RFP_Question.RFP_Title, RFP_Question.Deadline, RFP_Question.Budget, RFP_Question.Options, RFP_Question.ID_RFP_Question, RFP_Options.Notes FROM RFP_Question INNER JOIN RFP ON RFP_Question.ID_RFP = RFP.ID_RFP INNER JOIN RFP_Options ON RFP.ID_Options = RFP_Options.ID_Options">
                        </asp:SqlDataSource>
                    </div>
                    </div>                
    </div>
