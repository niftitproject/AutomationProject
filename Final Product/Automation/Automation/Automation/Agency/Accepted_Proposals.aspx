<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Accepted_Proposals.aspx.cs" Inherits="Automation.Agency.ManageNoti" %><%@ Register src="notiProposalAccepted.ascx" tagname="notiProposalAccepted" tagprefix="uc1" %>
    ...
    <form id="form1" runat="server">
			...
			<!-- MAIN -->
				...
				<div class="wrapper">
					...
					<!-- title -->
					<div id="page-title">
						<span class="title">Accepted Proposals</span>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                DataSourceID="SqlDataSource1" Width="672px" CellPadding="4" 
                        ...
                        <Columns>
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields="ID_Noti" 
                                DataNavigateUrlFormatString="~/Agency/Detail_Accepted_Proposals.aspx?id={0}" 
                                Text="Detail" />
                            <asp:HyperLinkField DataNavigateUrlFields="ID_Noti" 
                                DataNavigateUrlFormatString="~/Agency/exSeen.aspx?id={0}" Text="Seen" />
                        </Columns>
                        ...
                        <SortedDescendingHeaderStyle BackColor="#4870BE" />
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                ...
                                SelectCommand="SELECT Proposal.Company_Name, Noti.UserId, Noti.ID_Proposal, Noti.ID_RFP, RFP_Question.Name_Of_Customer, RFP_Question.RFP_Title, Noti.ID_Noti FROM Noti INNER JOIN RFP ON Noti.ID_RFP = RFP.ID_RFP INNER JOIN Proposal ON Noti.ID_Proposal = Proposal.ID_Proposal AND RFP.ID_RFP = Proposal.ID_RFP INNER JOIN RFP_Question ON RFP.ID_RFP = RFP_Question.ID_RFP WHERE (Noti.unSeen = 0)">
                            </asp:SqlDataSource>    
                            </div>
