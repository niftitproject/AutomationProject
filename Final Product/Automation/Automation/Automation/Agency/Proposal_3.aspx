<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Proposal_3.aspx.cs" Inherits="Automation.Agency.Proposal__3_" %>
...
<head>
    ...
    <form id="form1" runat="server">
            ...
            <h6 class="line-divider">STAFFING STRUCTURE
            <img src="../img/mono-icons/notepencil32.png" title="arrowright32.png"/></h6><br />
            <h6 class="line-divider">BUDGETING</h6>
					</div>
						<div class="two-third last">
						<asp:Label ID="Label9" runat="server" Text="Who will take the role of Solution Architect?"></asp:Label>
                        <br />
                        <asp:TextBox ID="Role1" runat="server" Width="210px" Height="50px" 
                                TextMode="MultiLine"></asp:TextBox>
                        <br /><br />
                        <asp:Label ID="Label10" runat="server" Text="Who will take on the role of UI, UX designer?"></asp:Label>
                        <br />
                        <asp:TextBox ID="Role2" runat="server" Width="210px" Height="50px" 
                                TextMode="MultiLine"></asp:TextBox>
                        <br /><br />
                        <asp:Label ID="Label11" runat="server" Text="Who will take on the role of Developer?"></asp:Label>
                        <br />
                        <asp:TextBox ID="Role3" runat="server" Width="210px" Height="50px" 
                                TextMode="MultiLine"></asp:TextBox>
                        <br /><br />
                        <asp:Label ID="Label12" runat="server" Text="Who will take up QA Engineer role?"></asp:Label>
                        <br />
                        <asp:TextBox ID="Role4" runat="server" Width="210px" Height="50px" 
                                TextMode="MultiLine"></asp:TextBox>
                        <br /><br />
                        <asp:Label ID="Label3" runat="server" Text="Who will take on the role of Project manager?"></asp:Label>
                        <br />
                        <asp:TextBox ID="Role5" runat="server" Width="210px" Height="50px" 
                                TextMode="MultiLine"></asp:TextBox>
                        <br /><br />
