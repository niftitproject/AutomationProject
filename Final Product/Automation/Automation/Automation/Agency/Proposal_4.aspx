<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Proposal_4.aspx.cs" Inherits="Automation.Agency.Proposal__4_" %>
...
<head>
    ...
    <form id="form1" runat="server">
            ...
            <h6 class="line-divider">BUDGETING
            <img src="../img/mono-icons/notepencil32.png" title="arrowright32.png"/></h6>
					</div>
						<div class="two-third last">
						<asp:Label ID="Label9" runat="server" Text="What is the discounted cost?"></asp:Label>
                        <br />
                        <asp:TextBox ID="Discounted" runat="server" Width="210px" Height="50px" 
