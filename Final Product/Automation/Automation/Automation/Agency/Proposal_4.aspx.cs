    ...
    public partial class Proposal__4_ : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(constring))
            {
                ...
                stamper.Close();
                InsertProposalInformation(fileNameForDB);
                InsertNoti(id);
       ...
       private void InsertProposalInformation(String Proposal_URL)
        {
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["ApplicationServices"].ConnectionString))
            {
                ...
                String query = "INSERT INTO Proposal(ID_RFP, Company_Name, UserId, Context, Status) VALUES(" + ID_RFP + ",'" + companyName + "', '" + userID + "', '" + Proposal_URL + "', 'Pending')";
